...
2. Copy code from [submit_request.py](submit_request.py).
...
4. In the code editor, replace everything with the content of [step-functions-json](step-functions-json).
